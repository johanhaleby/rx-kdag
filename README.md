...
1. Convert the list of sentences loaded from `sentences.txt` into an Observable then solve the problem in a <a href="http://en.wikipedia.org/wiki/Functional_reactive_programming">FRP</a> style.
